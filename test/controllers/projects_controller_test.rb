...
class ProjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  #   patch project_url(@project), params: { project: { description: @project.description, fieldOfEducation: @project.fieldOfEducation, fieldOfHealth: @project.fieldOfHealth, fieldOfWelfare: @project.fieldOfWelfare, image: @project.image, information: @project.information, name: @project.name, videofile: @project.videofile, website: @project.website } }
